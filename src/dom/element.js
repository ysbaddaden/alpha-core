(function () {
  ...
  // Implements textContent for IE8 and older browsers.
  if (typeof elm.textContent === 'undefined') {
    ...
    if (Object.defineProperty) {
      ...
      Element.prototype.__defineGetter__('textContent', Element.prototype._alpha_get_textContent);
    }
  }
  
  // Emulates the non-standard innerText in non-IE browsers, since you can't
  // emulate textContent behavior in IE < 8.
  ...
  if (typeof elm.children === 'undefined') {
    ...
    if (Object.defineProperty) {
      ...
      Element.prototype.__defineGetter__('children', Element.prototype._alpha_get_children);
    }
  }
  ...
  if (typeof elm.childElementCount === 'undefined') {
    ...
    if (Object.defineProperty) {
      Object.defineProperty(Element.prototype, 'childElementCount', {
        get: Element.prototype._alpha_get_childElementCount
      });
      Object.defineProperty(Element.prototype, 'firstElementChild', {
        get: Element.prototype._alpha_get_firstElementChild
      });
      Object.defineProperty(Element.prototype, 'lastElementChild', {
        get: Element.prototype._alpha_get_lastElementChild
      });
      Object.defineProperty(Element.prototype, 'nextElementSibling', {
        get: Element.prototype._alpha_get_nextElementSibling
      });
      Object.defineProperty(Element.prototype, 'previousElementSibling', {
        get: Element.prototype._alpha_get_previousElementSibling
      });
    } else if (Element.prototype.__defineGetter__) {
